...
.factory('LoginService', function($http, $q) {
    ...
    return {
        ...
        UserRegister: function(mobile, password) {
            var deferred = $q.defer();
            var promise = deferred.promise;

            $http.get(appurl + 'UserRegister', {
                params: {
                    mobile: mobile,
                    password: password
                }
...
.factory('FarmService', function($http, $q) {
    ...
    return {
        ...
        GetOriginTrack: function (data) {
            var deferred = $q.defer();
            var promise = deferred.promise;

            $http.get(weburl + '/app/GetOriginTrack', {
                params: data
            }).success(function(data) {
                deferred.resolve(data);
            }).error(function() {
        ...
        /* 获取单个耳号的简单信息*/
        GetPlainName: function (data) {
            var deferred = $q.defer();
            var promise = deferred.promise;

            $http.get(weburl + '/app/GetPlainName', {
                params: {
                    SysDepID: user.PeID,
                    SysRoleID: user.RoleId,
                    PNO: data,
...
.factory('ServiceService', function($http, $q) {
    ...
    return {
        ...
        CompleteOrder: function(id) {
            ...
            $http.get(weburl + '/ServiceApp/CompleteOrder', {
                params: {
                    SysDepID: user.PeID,
                    SysRoleID: user.RoleId,
                    id: id
        ...
        datapoints: function() {
            ...
            $http.get(weburl + '/ServiceApp/GetWeightAllMethod').success(function(data) {
                deferred.resolve(data);
            }).error(function() {
                deferred.reject('数据错误.');
            });
